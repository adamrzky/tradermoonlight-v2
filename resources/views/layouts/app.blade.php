...
<head>
  ...
  <title>tradermoonlight</title>

  <link rel="shortcut icon" href="{{ asset('assets-fugu/images/favicon.ico"') }} type="image/x-icon">
  <link rel="icon" href="{{ asset('assets-fugu/images/favicon.ico"') }} type="image/x-icon">
  <!--- End favicon-->
  ...
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/bootstrap.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/fontawesome.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/slick.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/magnific-popup.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/swiper-bundle.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/icomoon-font.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/animate.css') }}" />


  <!-- Code Editor  -->

  <link rel="stylesheet" href="{{ asset('assets-fugu/css/main.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets-fugu/css/app.min.css') }}" />
</head>
...
<body class="light">
          ...
          <nav class="menu-block" id="append-menu-header">
            ...
            <ul class="site-menu-main">
              ...
              <li class="header-btn header-btn-l1 fugu-responsive-btn">
                <a class="fugu--btn fugu--menu-btn1" href="contact.html">
                  Connect Wallet
                </a>
              </li>
            </ul>
  ...
  <footer class="fugu--footer-section">
    <div class="container">
      ...
      <div class="fugu--footer-bottom">
        <p>&copy; Copyright 2023, All Rights Reserved by Adamrzkyv </p>
        <div class="fugu--footer-menu">
          <ul>
  ...
  <!-- scripts -->
  <script src="{{ asset('assets-fugu/js/jquery-3.6.0.min.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/menu/menu.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/slick.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/jquery.magnific-popup.min.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/swiper-bundle.min.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/countdown.js') }}"></script>
  <script src="{{ asset('assets-fugu/js/wow.min.js') }}"></script>
  <script src="https://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyArZVfNvjnLNwJZlLJKuOiWHZ6vtQzzb1Y"></script>

  <script src="{{ asset('assets-fugu/js/app.js') }}"></script>
</body>
</html>